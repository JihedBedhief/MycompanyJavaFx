 ...
 */
public class ModifierPointVenteController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
           ...
           UnaryOperator<TextFormatter.Change> integerFilter = change -> {
            ...
            PointVente e = pv.get_PointVente(AfficherPointVenteController.ide);
            
            nom.setText(e.getNom());
            region.setText(e.getRegion());
            ville.setText(e.getVille());
            email.setText(e.getEmail());
            tel.setText(String.valueOf(e.getTel()));
            code.setText(String.valueOf(e.getCodePostal()));
    }    
    ...
    private void Ajouter(ActionEvent event) throws SQLDataException {
        ...
        if (nom.getText().equals("") || region.getText().equals("") || email.getText().equals("") || ville.getText().equals("")|| tel.getText().equals("0") || code.getText().equals("0")){
           ...
           alert.showAndWait();
            ...
            p.setId(AfficherPointVenteController.ide);
            pv.ModifierPointVente(p);
            
            Alert alert = new Alert(Alert.AlertType.INFORMATION, "Modifier Avec Succés", ButtonType.OK);
            alert.showAndWait();
